    ...
    // En cualquier otro caso...
        ...
        if (isset($_POST)&&!empty($_POST)) {
            ...
            if (isset($_POST['delete'])) {
                ...
                // Iniciamos la transacción para borrar el departamento.
            ...
            // Si queremos actualizar los departamentos...
                ...
                foreach ($_POST['name'] as $key => $val) {
                    ...
                    if (!$conexion->query("UPDATE departments SET dept_name = '$val' WHERE dept_no = '$key' AND ('$val' != '' AND '$val' != dept_name)")) {
